...
try{
this.implementations[$0]={constructor:$1}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
lz=new LzInheritedHash();lz["ClassAttributeTypes"]=new LzInheritedHash();lz.ClassAttributeTypes["Object"]={}}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
(arguments.callee["$superclass"]&&arguments.callee.$superclass.prototype["$lzsc$initialize"]||this.nextMethod(arguments.callee,"$lzsc$initialize")).call(this);this.PresentationTypes={}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}})(LzNode);lz[LzNode.tagname]=LzNode;Class.make("$lzc$class_userClassPlacement",["$lzsc$initialize",function($0,$1,$2,$3){
try{
switch(arguments.length){
case 0:
$0=null;
...
$2.__intervalID=setIntervalNoArgs(LzIdleKernel.__update,1000/$2.__fps)
}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
clearInterval(LzIdleKernel.__intervalID);LzIdleKernel.__intervalID=setIntervalNoArgs(LzIdleKernel.__update,1000/$0)
}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
if(!$0)$0=window.event;var $1={};var $2=false;var $3=$0["keyCode"];var $4=$0.type;var $5=$0.shiftKey;var $6=LzKeyboardKernel.__downKeysHash;if($3>=0&&$3!=16&&$3!=17&&$3!=18&&$3!=224){
var $7=String.fromCharCode($3).toLowerCase();if($4=="keyup"){
if($6[$7]!=null){
$1[$7]=false;$2=true
};$6[$7]=null
}else if($4=="keydown"){
...
throw $lzsc$e
}}},__callback:null,__scope:null,__cancelKeys:true,__lockFocus:null,setCallback:function($0,$1){
try{
...
throw $lzsc$e
}}}};var LzMouseKernel={__lastMouseDown:null,__lastMouseOver:null,__lastMouseOut:null,__lastMouseContext:null,__maccontextshown:false,__x:0,__y:0,owner:null,__showncontextmenu:null,__mouseEvent:function($0){
try{
$0=$0||window.event;var $1=$0.target||$0.srcElement;var $2="on"+$0.type;if($2=="onmousedown")LzMouseKernel.__applicationFocus();if(window["LzKeyboardKernel"]&&LzKeyboardKernel["__updateControlKeys"]){
...
if(lz.embed.browser.OS=="Mac"&&$0.button!=2){
...
if($0==="onclick"&&$1==null){
return
};if($0==="onmouseup"&&LzMouseKernel.__maccontextshown){
LzMouseKernel.__maccontextshown=false;return
...
return
};var $0=LzSprite.__defaultStyles.hyphenate($0);LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor",$0);LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor",$0);if(LzSprite.quirks.fix_clickable){
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor",$0);LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor",$0)
}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
if(LzSprite.quirks.no_cursor_colresize){
return
};if(LzMouseKernel.__amLocked)return;LzSprite.prototype.__setCSSClassProperty(".lzdiv","cursor","pointer");LzSprite.prototype.__setCSSClassProperty(".lzcanvasdiv","cursor","default");if(LzSprite.quirks.fix_clickable){
LzSprite.prototype.__setCSSClassProperty(".lzclickdiv","cursor",LzMouseKernel.__showhand);LzSprite.prototype.__setCSSClassProperty(".lzcanvasclickdiv","cursor","default")
}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
LzMouseKernel.__lastMouseContext=LzMouseKernel.__lastMouseDown;LzMouseKernel.__lastMouseDown=null;LzMouseKernel.__lastMouseOver=null;LzMouseKernel.__lastMouseOut=null
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
LzMouseKernel.__contextmenumouse2=$5;var $6=$1.owner instanceof LzSprite?$1.owner.owner:null;$2.kernel.__show($6);return false
}};return true
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}},__applicationFocused:false,__applicationFocus:function(){
try{
if(!LzMouseKernel.__applicationFocused){
LzMouseKernel.__applicationFocused=true;if(LzSprite.quirks.fix_ie_clickable){
...
$6=document.createElement("div");$6.className="lzappoverflow";$5.appendChild($6);$6.owner=this;if($1["fix_div_mouse_scrolling"]){
$6.addEventListener("scroll",function($0){
if($0&&$0.target&&$0.target.className&&$0.target.className=="lzappoverflow"){
$0.target.scrollTop=0;$0.target.scrollLeft=0
}},true)
};LzSprite.__rootSpriteOverflowContainer=$6
...
$3=true
}};if(lz.embed.browser.isIE&&$1 instanceof HTMLIFrameElement){
$3=true
};if($3){
...
if($4.version<13){
$2.borderRadius="MozBorderRadius";$2.boxShadow="MozBoxShadow"
};$2.userSelect="MozUserSelect";$2.transform="MozTransform";$2.transformOrigin="MozTransformOrigin";$0["inputtext_anonymous_div"]=true;if($4.OS=="Windows"){
...
$3=LzSprite.__clickDispatcher($0);return $3
};var $4="on"+$0.type;if($4=="onmouseup"){
var $5=LzMouseKernel.__lastMouseDown;if($5&&$5!==$2){
$5.__globalmouseup($0)
};LzMouseKernel.__lastMouseDown=null;LzMouseKernel.__lastMouseContext=null
}else if($4=="onmousedown"){
var $6=LzInputTextSprite.prototype.__focusedSprite;if($6&&$6!==$2){
$6.deselect()
};LzMouseKernel.__lastMouseDown=$2;$2.__mouseisdown=true
...
return
};var $1=$0.target||$0.srcElement;var $2=$1&&$1.owner;if(!$2)return;var $3="on"+$0.type;if($3=="onmousedown")LzMouseKernel.__applicationFocus();if(LzSprite.quirks.ie_mouse_events){
if($3=="onmouseenter"){
$3="onmouseover"
...
var $6=lz.BrowserUtils.getcallbackfunc($2,"__mouseEvent",["onmouseupoutside"]);setTimeoutNoArgs($6,0)
};var $6=lz.BrowserUtils.getcallbackfunc($2,"__mouseEvent",["onmouseout"]);setTimeoutNoArgs($6,0);$6=lz.BrowserUtils.getcallbackfunc($2,"__mouseEvent",["onclick"]);setTimeoutNoArgs($6,0)
}else{
return true
...
if($0.button==2)return;$2.__mouseisdown=true;LzMouseKernel.__lastMouseDown=$2;var $7=LzInputTextSprite.prototype.__focusedSprite;if($7&&$7!==$2){
$7.deselect()
}}else if($3=="onmouseup"){
if($0.button==2)return;var $8=LzMouseKernel.__lastMouseDown;if(LzMouseKernel.__lastMouseContext){
LzMouseKernel.__lastMouseContext.__mouseisdown=false;LzMouseKernel.__lastMouseContext.__globalmouseup($0)
}else if($8&&$8!==$2){
$8.__globalmouseup($0)
};LzMouseKernel.__lastMouseContext=null;if($8!==$2){
LzMouseKernel.__lastMouseDown=null;if($2)$2.__mouseisdown=false;return
}else{
...
throw $lzsc$e
}}};LzSprite.prototype.__LZimg=null;LzSprite.prototype.playing=false;LzSprite.prototype.frame=1;LzSprite.prototype.frames=null;LzSprite.prototype.is_html=false;LzSprite.blankimage="lps/includes/blank.gif";LzSprite.prototype.resourceurl=null;LzSprite.prototype.resource=null;LzSprite.prototype.source=null;LzSprite.prototype.stretches=null;LzSprite.prototype.resourceWidth=null;LzSprite.prototype.resourceHeight=null;LzSprite.prototype.cursor=null;LzSprite.prototype.loading=false;LzSprite.prototype.setResource=function($0){
try{
...
try{
if(this.__LZimg){
var $1=$0?"url('"+$0+"')":"none";this.__bgimage=this.__LZimg.style.backgroundImage=$1
};if($1!=null){
...
im.owner=this.owner;im.onload=lz.BrowserUtils.getcallbackfunc(this.owner,"__imgonload",[im]);im.onerror=lz.BrowserUtils.getcallbackfunc(this.owner,"__imgonerror",[im]);var $2=lz.BrowserUtils.getcallbackfunc(this.owner,"__imgontimeout",[im]);this.owner.__imgtimoutid=setTimeoutNoArgs($2,LzSprite.medialoadtimeout)
};im.src=$0
...
try{
var $1=LzSprite.__rootSpriteContainer;$1.style.position="absolute";$1.style.left=LzSprite.prototype.CSSDimension($0);setTimeoutNoArgs(LzScreenKernel.__resizeEvent,0)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
LzSprite.__rootSpriteContainer.style.width=LzSprite.prototype.CSSDimension($0);setTimeoutNoArgs(LzScreenKernel.__resizeEvent,0)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
var $1=LzSprite.__rootSpriteContainer;$1.style.position="absolute";$1.style.top=LzSprite.prototype.CSSDimension($0);setTimeoutNoArgs(LzScreenKernel.__resizeEvent,0)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
LzSprite.__rootSpriteContainer.style.height=LzSprite.prototype.CSSDimension($0);setTimeoutNoArgs(LzScreenKernel.__resizeEvent,0)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
var $0=this.__getPos();return {x:LzMouseKernel.__x-$0.x,y:LzMouseKernel.__y-$0.y}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){

}else{
throw $lzsc$e
}}};LzSprite.prototype.__poscache=null;LzSprite.prototype.__poscacheid=0;LzSprite.__poscachecnt=0;LzSprite.prototype.__getPos=function(){
try{
...
try{
var $1=(this._xscale||"")+(this._yscale||"")+(this._rotation||"");var $2=lz.embed.browser;if($2.isIE&&$2.version>=9)this.__LZdiv.style["-ms-transform"]=$1;if($1===this._transform)return;this._transform=$1;var $3=LzSprite.__styleNames.transform;this.__LZdiv.style[$3]=$1;if(this.__LZclickcontainerdiv){
this.__LZclickcontainerdiv.style[$3]=$1
};if(this.__LZcontextcontainerdiv){
this.__LZcontextcontainerdiv.style[$3]=$1
}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}};LzSprite.prototype.setID=function($0){
try{
...
var $1=lz.BrowserUtils.getcallbackstr(this,"__initcanvasie");this.__canvasTId=setTimeoutNoArgs($1,50)
}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
};this.__updatefieldsizeTID=setTimeoutNoArgs($1,0)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
$1+=this.__wpadding
};if($1!=0&&this.quirks["fix_ie9_textwidth"]){
$1+=1
};return $1
}
catch($lzsc$e){
...
case "height":
if($1.length>0&&$1.charAt($1.length-1)=="\n"){
$1=$1+"a"
}$2=this.scrolldiv.style.width;break;
case "width":
if(this.text==""){
return 0
}break;
...
throw $lzsc$e
}}};LzTextSprite.prototype.__textareaToRange=function($0){
try{
...
throw $lzsc$e
}}};LzTextSprite.prototype.__lineheight="";LzTextSprite.prototype.__updatewhitespace=function(){
try{
this.scrolldiv.style.lineHeight=this.__lineheight
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
this.__heightcss=$4;var $5=this.scrolldiv;this.__lineheight=$5.style.lineHeight;$5.style.height=$4;if(this.quirks.fix_ie_divheight_change){
$5.style.lineHeight="inherit";var $6=lz.BrowserUtils.getcallbackfunc(this,"__updatewhitespace",[]);setTimeoutNoArgs($6,0)
};if(this.scrolling){
var $7=$3(this.width||0);$5.style.clip="rect(0 "+$7+" "+$4+" 0)"
...
};if(!lz.embed.browser.isIE)this.__LZinputclickdiv.className="lzclickdiv";this.__LZinputclickdiv.owner=this;if(!lz.embed.browser.isIE)this.setClickable(true);if(!this.__LZclickcontainerdiv){
this.__LZclickcontainerdiv=this.__createContainerDivs("click")
...
var $2=this.__LzInputDiv;this.__setTextEvents(false);this.__createInputDiv($0?"multiline":"");var $3=this.__LzInputDiv;if(this.quirks["fix_ie_css_syntax"]){
...
};var $4=$2.scrollLeft;var $5=$2.scrollTop;this.__discardElement($2);this.__LZdiv.appendChild($3);$3.style.margin="0px";if(!$0)$3.style.height="auto";$3.scrollLeft=$4;$3.scrollTop=$5;this.setScrollEvents(this.owner.scrollevents);$3.setAttribute("style",$2.style.cssText);this.__setTextEvents(true);this.setText(this.text,true)
}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
if(this.__shown==true)return;this.__hideIfNotFocused();LzInputTextSprite.prototype.__lastshown=this;this.__shown=true;if(this.quirks["inputtext_parents_cannot_contain_clip"]){
...
try{
if(this.__shown!=true)return;if(LzInputTextSprite.prototype.__lastshown==this){
...
$1.onmouseout=$2
};$1.onmousemove=$2;$1.onmousedown=$2;$1.onmouseup=$2;$1.onkeyup=$2;$1.onkeydown=$2;$1.onkeypress=$2;$1.onchange=$2;$1.onpaste=this.__pasteText
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
var $b=this.__LzInputDiv.value;var $c=this.getSelectionPosition();this.text=$b.substring(0,$c)+$3+$b.substring($c+$5);this.__LzInputDiv.value=this.text;$c+=$3.length;this.__LzInputDiv.setSelectionRange($c,$c)
}else{
...
this.__show()
};var selpos=this.getSelectionPosition();var selsize=this.getSelectionSize();var val=this.__LzInputDiv.value;var that=this;setTimeoutNoArgs(function(){
...
};that.text=val.substring(0,selpos)+$6+val.substring(selpos+selsize);that.__LzInputDiv.value=that.text;selpos+=$6.length;that.__LzInputDiv.setSelectionRange(selpos,selpos)
}},1)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}};LzInputTextSprite.prototype.__pasteText=function($0){
try{
var view=this.owner.owner;var that=this;setTimeoutNoArgs(function(){
var $0=that.value;that.owner.text=$0;view.inputtextevent("onchange",$0)
},10)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
};var $2=$0.target||$0.srcElement;var $3=$2&&$2.owner;var $4="on"+$0.type;if(LzSprite.quirks.ie_mouse_events){
if($4==="onmouseleave"){
$4="onmouseout"
}};var $5=$1.quirks;if($4==="onmousedown"||$4==="onmouseup"||$4==="onmouseout"||$4==="onmousemove"){
...
if($1.dragging){
var $6=$1.__LzInputDiv;var $7=$0.pageY-$6.offsetTop;if($7<=3){
$6.scrollTop-=$1.lineHeight?$1.lineHeight:10
};if($7>=$6.clientHeight-3){
$6.scrollTop+=$1.lineHeight?$1.lineHeight:10
}}}};if($4==="onmouseout"){
$1.__hide();$1.__mouseEvent($4)
}else if($4==="onmousedown"){
$1.__mouseisdown=true
}else if($4==="onmouseup"){
$0.cancelBubble=true;var $8=LzMouseKernel.__lastMouseDown;if(!$1.__isMouseOver()){
$1.__globalmouseup($0)
}else{
if(!$8||!$3||$8===$3){
$1.__mouseEvent($4)
...
if($4==="onfocus"){
var $9=lz.Focus.getFocus();var $a=$9!=null&&$9.sprite.is_html;$1.__show();$1.__LzInputDiv.blur();LzInputTextSprite.prototype.__lastfocus=$1;LzKeyboardKernel.setKeyboardControl(true);if($a){
return
};$1.__skipevent=true
}};var $b=this.owner.owner;if($4==="onfocus"){
...
};$1.deselect();if(lz.embed.browser.isChrome||lz.embed.browser.isSafari){
var $c=window.getSelection();if($c)$c.removeAllRanges()
};if($1._cancelblur){
$1._cancelblur=false;return
}}else if($4==="onkeypress"){
if($1.restrict||$1.multiline&&$b.maxlength&&$b.maxlength<Infinity){
var $d=$0.keyCode;var $e=$5.text_event_charcode?$0.charCode:$0.keyCode;var $f=!($0.ctrlKey||$0.altKey)&&($e>=32||$d===13);if($f){
var $g=false;if($d!=13&&$1.restrict){
$g=0>String.fromCharCode($e).search($1.restrict)
};if(!$g){
var $h=$1.getSelectionSize();if($h===0){
if($5.text_ie_carriagereturn){
var $i=$1.__LzInputDiv.value.replace($1.____crregexp,"\n")
}else{
var $i=$1.__LzInputDiv.value
};var $j=$i.length,$k=$b.maxlength;if($j>=$k){
$g=true
}}};if($g){
$0.returnValue=false;if($0.preventDefault){
$0.preventDefault()
...
var $l=false;if($0.ctrlKey&&!$0.altKey&&!$0.shiftKey){
var $m=String.fromCharCode($e);$l=$m==="v"||$m==="V"
...
var $j=$1.__LzInputDiv.value.length,$k=$b.maxlength;if($j<$k||$1.getSelectionSize()>0){
$1.__pasteHandler()
}else{
$0.returnValue=false;if($0.preventDefault){
$0.preventDefault()
...
var $6=$1.__LzInputDiv;var $n=$6.value;if($n!=$1.text){
$1.text=$n;if($1.multiline){
if($1.quirks["forcemeasurescrollheight"]){
$6.style.height=0;var $o=$6.scrollTop;$6.scrollTop=0;if($1._h!=0){
$6.style.height=$1._h
};if($o!=0){
$6.scrollTop=$o
}}};$b.inputtextevent("onchange",$n)
};if(lz.embed.browser.isFirefox&&$5.autoscroll_textarea&&$4==="onkeydown"&&$6.selectionStart===$n.length){
setTimeoutNoArgs(LzInputTextSprite.prototype.__updateScrollTopToShownLastLine($6),50)
}}else{
$b.inputtextevent($4)
}}}
catch($lzsc$e){
...
throw $lzsc$e
}}};function updateScrollTopToShownLastLine($0){
try{
$0.scrollTop=$0.scrollHeight-$0.clientHeight+20
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
catch($0){};LzInputTextSprite.prototype.__lastfocus=this;setTimeoutNoArgs(LzInputTextSprite.prototype.__selectLastFocused,50);if(window["LzKeyboardKernel"])LzKeyboardKernel.__cancelKeys=false
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
var $0=this.__LzInputDiv.maxLength;if($0!=Infinity)this.setMaxLength(Infinity);this.__LzInputDiv.focus();var $1=document.selection.createRange();var $2=$1.getBookmark();var $3=contents=this.__LzInputDiv.value;do{
var $4="~~~"+Math.random()+"~~~"
}while(contents.indexOf($4)!=-1);var $5=$1.parentElement();if($5==null||!($5.type=="text"||$5.type=="textarea")){
return
};$1.text=$4+$1.text+$4;contents=this.__LzInputDiv.value;var $6={};$6.start=contents.indexOf($4);contents=contents.replace($4,"");$6.end=contents.indexOf($4);if($0!=Infinity)this.setMaxLength($0);this.__LzInputDiv.value=$3;$1.moveToBookmark($2);$1.select();return $6
...
$j=$i.indexOf("\r\n",$j+2);if($j==-1)break;$m++
};$f-=$k;$g-=$l+$k;return {start:$f,end:$g}}}}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}};LzInputTextSprite.prototype.$LzTextSprite$destroy=LzTextSprite.prototype.destroy;LzInputTextSprite.prototype.destroy=function(){
try{
this.$LzTextSprite$destroy();if(LzInputTextSprite.prototype.__focusedSprite===this){
LzInputTextSprite.prototype.__focusedSprite=null
}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
$0.__timeoutID=setTimeoutOneArg(LzHTTPLoader.__LZhandleXMLHTTPTimeout,$1,$0)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
LzMouseKernel.__showncontextmenu=this;var $1=this.owner;var $2=this._delegate;if($2!=null)$2.execute($1);if($1.onmenuopen.ready)$1.onmenuopen.sendEvent($1);var $3=[];var $4=$1._filteredItems($0);this.kernelItems=[];var $5={};for(var $6=0;$6<$4.length;$6++){
...
throw $lzsc$e
}}}]);setTimeoutOrig=window.setTimeout;setTimeoutNoArgs=window.setTimeout;setTimeoutOneArg=function(callback,$0,arg){
try{
var $1=function(){
callback(arg)
};return setTimeoutOrig($1,$0)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}};setIntervalNoArgs=window.setInterval;(function(){
try{
...
throw $lzsc$e
}}},setTimeoutOneArg:function(callback,$0,arg){
try{
var $1=function(){
callback(arg)
};return setTimeoutNoArgs($1,$0)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}},setTimeoutTwoArg:function(callback,$0,arg1,arg2){
try{
var $1=function(){
callback(arg1,arg2)
};return setTimeoutNoArgs($1,$0)
...
throw $lzsc$e
}}},setTimeoutNoArgs:function($0,$1){
try{
return setTimeoutNoArgs($0,$1)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}};LzFontManager.__sizecache={counter:0};LzFontManager.__sizecacheupperbound=50;LzFontManager.__rootdiv=null;LzFontManager.__clearMeasureCache=function(){
try{
...
throw $lzsc$e
}}};LzFontManager.setMaxCacheSize=function($0){
try{
LzFontManager.__sizecacheupperbound=$0
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}})(LzView);lz[LzView.tagname]=LzView;Class.make("LzTextscrollEvent",["__senderscope",void 0,"$lzsc$initialize",function($0,$1,$2){
try{
switch(arguments.length){
case 2:
$2=null;
...
};(arguments.callee["$superclass"]&&arguments.callee.$superclass.prototype["$lzsc$initialize"]||this.nextMethod(arguments.callee,"$lzsc$initialize")).call(this,$0,$1,$2,$3);this._selectableset=$1&&("selectable" in $1)?true:false
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}},"_selectableset",false,"selectable",false,"onselectable",LzDeclaredEvent,"$lzc$set_selectable",function($0){
try{
$0=!(!$0);this._selectableset=true;this.selectable=$0;this.tsprite.setSelectable($0);if(this.onselectable.ready)this.onselectable.sendEvent($0)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
this._oninitdeltaDel=new LzDelegate(this,"_handleChrome",this,"oninit")
}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}},"_handleChrome",function($0){
try{
switch(arguments.length){
case 0:
$0=null;

};var $1=this.text;this.tsprite.setText("eeee");this.tsprite.setText($1)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
var $2=lz.Keys.isKeyDown("tab");lz.Focus.setFocus(this,$2?lz.Focus.KEYBOARD_PREV:lz.Focus.KEYBOARD);if(lz.Focus.getFocus()!==this&&this._focused){
this._gotBlurEvent()
}}}else if($0=="onchange"){
var $3=this.isprite.getText();var $4=this.text!==$3;this.text=$3;if(this.multiline&&!this.hassetheight){
var $5=this.isprite.getTextfieldHeight();if(this.height!=$5){
this.updateHeight($5)
}};if($4)this.tsprite.__updatefieldsize();if($4&&this.ontext.ready)this.ontext.sendEvent(this.text)
}else if($0=="onblur"){
this._focused=false;if(lz.Focus.getFocus()===this){
var $2=lz.Keys.isKeyDown("tab");if($2){
...
throw $lzsc$e
}}})(LzContextMenuItem);lz[LzContextMenuItem.tagname]=LzContextMenuItem;Class.make("LzFont",["style",void 0,"name",void 0,"height",void 0,"ascent",void 0,"descent",void 0,"advancetable",void 0,"lsbtable",void 0,"rsbtable",void 0,"fontobject",void 0,"$lzsc$initialize",function($0,$1,$2){
try{
...
(arguments.callee["$superclass"]&&arguments.callee.$superclass.prototype["$lzsc$initialize"]||this.nextMethod(arguments.callee,"$lzsc$initialize")).call(this)
},"clearLoaderCache",function(){
try{
(arguments.callee["$superclass"]&&arguments.callee.$superclass.prototype["clearLoaderCache"]||this.nextMethod(arguments.callee,"clearLoaderCache")).call(this);if(this.__loaders==null)return;for(var $0=this.__loaders.length-1;$0>-1;$0--){
...
try{
this.clearLoaderCache();(arguments.callee["$superclass"]&&arguments.callee.$superclass.prototype["destroy"]||this.nextMethod(arguments.callee,"destroy")).call(this)
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
(arguments.callee["$superclass"]&&arguments.callee.$superclass.prototype["$lzsc$initialize"]||this.nextMethod(arguments.callee,"$lzsc$initialize")).call(this);this.d={}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
$1={counter:0}};$0=LzColorUtils.hextoint($0);var $3=LzColorUtils.hsvafrominternal($0);return $1[$2]={h:$3[0],s:$3[1],v:$3[2],a:$3[3]}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){

}else{
throw $lzsc$e
}}},"fromhsv",function($0,$1,$2,$3){
try{
switch(arguments.length){
case 3:
$3=1;
...
throw $lzsc$e
}}})(LzCSSStyleRule);lz.CSSStyleRule=LzCSSStyleRule;Class.make("LzCSSStyleClass",["_idRules",void 0,"_nameRules",void 0,"_attrs",void 0,"_attrRules",void 0,"_tags",void 0,"_tagRules",void 0,"_rules",void 0,"$lzsc$initialize",function(){
try{
...
throw $lzsc$e
}}})(LzCSSStyleClass);var LzCSSStyle=new LzCSSStyleClass();lz.CSSStyle=LzCSSStyleClass;Class.make("LzCSSStyleDeclaration",["$lzsc$initialize",function(){},"_node",null,"getPropertyValue",function($0){
try{
...
throw $lzsc$e
}}})(LzCSSStyleDeclaration);lz.CSSStyleDeclaration=LzCSSStyleDeclaration;Class.make("LzStyleSheet",["$lzsc$initialize",function($0,$1,$2,$3){
try{
...
throw $lzsc$e
}}},"applicationBlur",function(){
try{
LzMouseKernel.__applicationBlur()
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
if(!$1||$1<1)$1=1;var $2={delegate:$0};var $3=LzTimeKernel.setTimeoutOneArg(this.execDelegate,$1,$2);$2.id=$3;var $4=$0.__delegateID;var $5=this.timerList[$4];if($5==null){
this.timerList[$4]=$3
...
throw $lzsc$e
}}})(LzTimerService);lz.TimerService=LzTimerService;lz.Timer=LzTimerService.LzTimer;lz.ClassAttributeTypes["lzcontextmenuseparator"]=LzNode.mergeAttributeTypes(lz.ClassAttributeTypes["view"],{});Class.make("$lzc$class_lzcontextmenuseparator",["$vsxbj91",function($0){
try{
...
throw $lzsc$e
}}}],LzView,["tagname","lzcontextmenuseparator","__LZCSSTagSelectors",["lzcontextmenuseparator","view","node","$lfc$LzEventable","Instance"],"attributes",new LzInheritedHash(LzView.attributes)]);(function($0){
try{
with($0)with($0.prototype){
{
LzNode.mergeAttributes({$CSSDescriptor:{},$attributeDescriptor:{types:lz.ClassAttributeTypes["lzcontextmenuseparator"]},$delegates:["oninit","$vsxbj91",null,"ondestroy","$vsxbj92",null],height:10},$lzc$class_lzcontextmenuseparator.attributes)
}}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}})($lzc$class_lzcontextmenuseparator);lz.ClassAttributeTypes["lzcontextmenutext"]=LzNode.mergeAttributeTypes(lz.ClassAttributeTypes["text"],{});Class.make("$lzc$class_lzcontextmenutext",["$vsxbj96",function($0){
try{
...
throw $lzsc$e
}}}],LzText,["tagname","lzcontextmenutext","__LZCSSTagSelectors",["lzcontextmenutext","text","view","node","$lfc$LzEventable","Instance"],"attributes",new LzInheritedHash(LzText.attributes)]);(function($0){
try{
with($0)with($0.prototype){
{
LzNode.mergeAttributes({$CSSDescriptor:{},$attributeDescriptor:{types:lz.ClassAttributeTypes["lzcontextmenutext"]},$delegates:["onmouseover","$vsxbj96",null,"onmouseout","$vsxbj97",null,"onmouseup","$vsxbj98",null],clickable:true,fgcolor:0,fontsize:11,fontstyle:"plain"},$lzc$class_lzcontextmenutext.attributes)
}}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}})($lzc$class_lzcontextmenutext);lz.ClassAttributeTypes["lzcontextmenudisabled"]=LzNode.mergeAttributeTypes(lz.ClassAttributeTypes["text"],{});Class.make("$lzc$class_lzcontextmenudisabled",["$lzsc$initialize",function($0,$1,$2,$3){
try{
switch(arguments.length){
case 0:
$0=null;
...
throw $lzsc$e
}}}],LzText,["tagname","lzcontextmenudisabled","__LZCSSTagSelectors",["lzcontextmenudisabled","text","view","node","$lfc$LzEventable","Instance"],"attributes",new LzInheritedHash(LzText.attributes)]);(function($0){
try{
with($0)with($0.prototype){
{
...
throw $lzsc$e
}}})($lzc$class_lzcontextmenudisabled);lz.ClassAttributeTypes["$lzc$class__vsxbj9f"]=LzNode.mergeAttributeTypes(lz.ClassAttributeTypes["view"],{});Class.make("$lzc$class__vsxbj9f",["$vsxbj9a",function($0){
try{
...
};if(this.parent._lockdrawing)return;$0.beginPath();$0.clearRect(0,0,this.width,this.height);LzKernelUtils.rect($0,2.5,3.5,this.width-3,this.height-3,this.classroot.inset);$0.fillStyle="#000000";$0.globalAlpha=0.2;$0.fill();$0.beginPath();LzKernelUtils.rect($0,0,0,this.width-3,this.height-3,this.classroot.inset);$0.globalAlpha=1;$0.fillStyle="#FFFFFF";$0.fill();$0.globalAlpha=1;$0.strokeStyle="#CCCCCC";$0.stroke();for(var $1 in this.parent.__drawnitems){
...
with($0)with($0.prototype){
{
LzNode.mergeAttributes({$CSSDescriptor:{},$attributeDescriptor:{types:lz.ClassAttributeTypes["$lzc$class__vsxbj9f"]}},$lzc$class__vsxbj9f.attributes)
}}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}})($lzc$class__vsxbj9f);lz.ClassAttributeTypes["lzcontextmenu"]=LzNode.mergeAttributeTypes(lz.ClassAttributeTypes["view"],{_lockdrawing:"boolean",defaultplacement:"string",inset:"number"});Class.make("$lzc$class_lzcontextmenu",["inset",void 0,"__drawnitems",void 0,"__overnow",void 0,"_lockdrawing",void 0,"$vsxbj99",function($0){
try{
...
try{
var $1=LzMouseKernel.__showncontextmenu;if($1)$1.__select($0);lz.GlobalMouse.__resetLastMouse();this.hide()
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
var $0=0;var $1=this.container.subviews;for(var $2=0;$2<$1.length;$2++){
var $3=$1[$2];if(!$3)continue;if($3 instanceof lz.lzcontextmenutext)$0=$3.getTextWidth()>$0?$3.getTextWidth():$0
};for(var $2=0;$2<$1.length;$2++){
var $3=$1[$2];if(!$3)continue;if($3.width!=$0)$3.setAttribute("width",$0)
}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
try{
this._lockdrawing=true;this.__drawnitems={};var $1=this.container.subviews;for(var $2=$1.length-1;$2>=0;$2--){
...
}};this.items=$0;this._lockdrawing=false;this.background.redraw()
}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
...
throw $lzsc$e
}}}],LzView,["tagname","lzcontextmenu","children",[{attrs:{$classrootdepth:1,$delegates:["oninit","$vsxbj9e",null,"onwidth","__doredraw",null,"onheight","__doredraw",null,"oncontext","__doredraw",null,"onvisible","__doredraw",null],height:new LzAlwaysExpr("$vsxbj9c","$vsxbj9d",null),name:"background",width:new LzAlwaysExpr("$vsxbj9a","$vsxbj9b",null)},"class":$lzc$class__vsxbj9f},{attrs:{$CSSDescriptor:{},$attributeDescriptor:{types:lz.ClassAttributeTypes["container"]},$classrootdepth:1,name:"container",x:3,y:3},"class":LzView},{attrs:"container","class":$lzc$class_userClassPlacement}],"__LZCSSTagSelectors",["lzcontextmenu","view","node","$lfc$LzEventable","Instance"],"attributes",new LzInheritedHash(LzView.attributes)]);(function($0){
try{
with($0)with($0.prototype){
{
LzNode.mergeAttributes({$CSSDescriptor:{},$attributeDescriptor:{types:lz.ClassAttributeTypes["lzcontextmenu"]},$delegates:["oninit","$vsxbj99",null],__drawnitems:{},__overnow:null,_lockdrawing:false,clickable:true,inset:5,options:{ignorelayout:true},showhandcursor:false,visible:false},$lzc$class_lzcontextmenu.attributes)
}}}
catch($lzsc$e){
if((Error["$lzsc$isa"]?Error.$lzsc$isa($lzsc$e):$lzsc$e instanceof Error)&&$lzsc$e!==lz["$lzsc$thrownError"]){
