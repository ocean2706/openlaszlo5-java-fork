...
lz.embed.dojo = {
    ...
    */
    ...
    installing: function(){
        ...
        // If flashUpgradeRequired() exists, call it before starting the
        // flash install.
        if (typeof(flashUpgradeRequired) != 'undefined') {
...
#pragma "passThrough=true"
    ...
    setVisible: function(/* Boolean */ visible){
        ...
        var div = this.properties.appenddiv 
        var container = div ? div : document.getElementById(this.properties.id + "Container");
        if(visible == true){
...
lz.embed.dojo.Install.prototype = {
    ...
    install: function(){
        ...
        var url = p.flash8;
        var update = false;
        if (url.indexOf('swf7') != -1) {
            update = true;
        } else if (url.indexOf('swf9') != -1) {
            update = true;
        } else if (url.indexOf('swf10') != -1) {
            update = true;
        } else {
        ...
        if (update) {
            dojo._tempurl = url;
            p.flash8 = lz.embed.__serverroot + 'swf8updater.lzx.swf8.swf';
        }
