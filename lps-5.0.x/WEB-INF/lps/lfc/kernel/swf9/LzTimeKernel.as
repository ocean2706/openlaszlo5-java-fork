...
function setTimeoutNoArgs = flash.utils.setTimeout;
function setTimeoutOneArg = flash.utils.setTimeout;
function setIntervalNoArgs = flash.utils.setInterval;
...
final class LzTimeKernelClass {
    ...
    // One arg and Two arg version (for dhtml compatability)
    public function setTimeoutNoArgs (closure:Function, delay:Number, ...args) :uint {
        return this.createTimer(delay, 1, closure, args);
    }
    public function setTimeoutOneArg (closure:Function, delay:Number, ...args) :uint {
        return this.createTimer(delay, 1, closure, args);
    }
    public function setTimeoutTwoArg (closure:Function, delay:Number, ...args) :uint {
        return this.createTimer(delay, 1, closure, args);
    }
