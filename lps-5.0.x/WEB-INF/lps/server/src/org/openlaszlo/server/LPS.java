...
public class LPS {
    ...
    public static String mDefaultFlexVersion = "10.1";
    ...
    /**  emit middle file
     */    
    public static boolean generateMiddle = false;
 ...
 */
    ...
    * @return the LOCALE property
    ...
    /*
     * set whether generate state file for lfc.lzx
     */    
    public static void setGenerateLfcStateFile(){
        String gen = LPS.getProperty("lfc.statefile.generate","false");
        generateMiddle = (gen.equals("true"));
