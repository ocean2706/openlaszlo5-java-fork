...
class CanvasCompiler extends ToplevelCompiler {
    ...
    public void compile(Element element) throws CompilationError
    {
        ...
        String lzproxied = mEnv.getCommandLineOption(CompilationEnvironment.PROXIED_PROPERTY);
        // canvas attribute
 ...
 */
            ...
            canvas.setProxied(mEnv.getBooleanProperty(CompilationEnvironment.PROXIED_PROPERTY));
        }
...
, element);
        ...
        if (scriptLimits != null) {
          try {
            Map<String, Object> properties = new CSSParser(new AttributeStream(element, "scriptlimits")).Parse();
            int recursion =
        ...
        Map<String, Object> map = createCanvasObject(element, canvas, model);
        String script;
        try {
            StringBuilder writer = new StringBuilder();
            writer.append("canvas = new ")
...
, element);
    ...
    private Map<String, Object> createCanvasObject(Element element, Canvas canvas, NodeModel model) {
        ...
        LinkedHashMap<String, Object> modelinits = (LinkedHashMap<String, Object>) map.get("attrs");
        if (modelinits == null) {
          map.put("attrs", inits);
        } else {
    ...
    protected void setDimension(Map<String, Object> attrs, String name, int value) {
