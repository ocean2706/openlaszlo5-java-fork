...
class LineMetrics {
    ...
    */
    ...
    public String toString() {
        return "LineMetrics: nlines="+nlines+" verbatim="+verbatim+ " str=|"+buf.toString()+"|";
    }
    ...
    */
    ...
    void addHTML (String rawtext, String normalized_text) {
        if (rawtext.length() == 0) {
            return;
        }
