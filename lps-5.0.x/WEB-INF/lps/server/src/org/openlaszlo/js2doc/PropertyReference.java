...
public class PropertyReference {
    ...
    protected org.w3c.dom.Element setClassValue(SimpleNode parseNode) {
        ...
        SimpleNode extendsNode = children[2];
        ...
        } else if (! (withList instanceof ASTEmptyExpression)) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("PropertyReference[");
