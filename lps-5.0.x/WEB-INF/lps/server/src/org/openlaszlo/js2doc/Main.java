...
public class Main {
    ...
    static final String[] runtimeOptionStrings = { "swf8", "swf9", "swf10", "dhtml" };
    ...
    static public boolean validateAndCompare(String sourceName,
        ...
        try {
            ...
            String sourceRoot = System.getProperty("JS2DOC_LIBROOT");
            JS2Doc.toXML(source, sourceFile, sourceRoot, libraryID, runtimeOptions, runtimeAliases, buildOptions, null);
