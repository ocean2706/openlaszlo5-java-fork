 ...
 */
                        org.openlaszlo.i18n.LaszloMessages.getMessage(
                                TTF2FFT.class.getName(),"051018-274", new Object[] {index, code, (char) code, glyph.getNumPoints()})
                );
            } else {
                mLogger.debug(
/* (non-Javadoc)
 ...
 */
                        org.openlaszlo.i18n.LaszloMessages.getMessage(
                                TTF2FFT.class.getName(),"051018-283", new Object[] {index, code})
                );
            }
 ...
 */
                        org.openlaszlo.i18n.LaszloMessages.getMessage(
                                TTF2FFT.class.getName(),"051018-421", new Object[] {ascent, descent, leading})
                                );
 ...
 */
                        org.openlaszlo.i18n.LaszloMessages.getMessage(
                                TTF2FFT.class.getName(),"051018-456", new Object[] {nKern})
);
 ...
 */
                        org.openlaszlo.i18n.LaszloMessages.getMessage(
                                TTF2FFT.class.getName(),"051018-472", new Object[] {goodKern})
);
                for (int i = 0; i < nKern; i++) {
