...
public class ComplexType
{
     ...
     */
    Map<String, QName> mMembers = null;
    ...
    /** The order of the members. Used when order of members matters, as defined
        in WSDL schema. */
    List<String> mMemberSequence = null;
     ...
     */
    public ComplexType(QName name, Map<String, QName> members) {
        mName = name;
        mType = TYPE_STRUCT;
        setMembers(members);
    }
     ...
     */
    public Map<String, QName> getMembers() {
        return mMembers;
    }
     ...
     */
    public void setMembers(Map<String, QName> members) {
        mMembers = members;
    }
     ...
     */
    public void setMembers(Map<String, QName> members, List<String> sequence) {
        mMembers = members;
    ...
    void toMembersXML(StringBuffer sb) {
        if (mMembers != null) {
            ...
            for (Map.Entry<String, QName> entry : mMembers.entrySet()) {
