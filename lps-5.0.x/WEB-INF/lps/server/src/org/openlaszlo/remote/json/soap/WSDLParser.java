...
public class WSDLParser
{
    ...
    HashMap<QName, ComplexType> mComplexTypeMap = new HashMap<QName, ComplexType>();
 ...
 */
        ...
        Map<String, LZSOAPOperation> operationMap = new HashMap<String, LZSOAPOperation>();
 ...
 */
            ...
            if (operationMap.containsKey(op.getName())) {
                ...
                LZSOAPOperation prevOp = operationMap.get(op.getName());
 ...
 */
    ...
    boolean isDocumentLiteralWrapped(LZSOAPOperation op) {
        ...
        List<LZSOAPPart> parts = inputMesg.getParts();
 ...
 */
    ...
    void bindMessage(LZSOAPMessage soapMessage, Element mesgElement, String tag) 
        ...
        List<LZSOAPPart> parts = new Vector<LZSOAPPart>();
        Set<String> partNames = soapMessage.getPartNames();
 ...
 */
            ...
            if (typeAttr != null) {
                ...
                ComplexType ct = mComplexTypeMap.get(qname);
                if (ct == null) {
 ...
 */
     ...
     */
    Set<String> getPartSet(String nmtokens) {
        Set<String> set = null;
