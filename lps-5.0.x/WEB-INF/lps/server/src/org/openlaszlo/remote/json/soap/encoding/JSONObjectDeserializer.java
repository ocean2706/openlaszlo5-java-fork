...
public class JSONObjectDeserializer extends DeserializerImpl
{
    ...
    HashMap<String, Object> mMembers = new HashMap<String, Object>();
 ...
 */
    ...
    public void setChildValue(Object value, String hint) throws SAXException
    { 
 ...
 */
        ...
        if (targets != null && !isHref) {
            ...
            if (componentsReady()) {
                ...
                body.append("{");
                int count = 0;
                for (Map.Entry<String, Object> entry : mMembers.entrySet()) {
