...
import org.openlaszlo.servlets.responders.Responder;
import org.openlaszlo.servlets.responders.ResponderLOGCONFIG;
import org.openlaszlo.servlets.responders.TemplateResponder;
...
public class LZServlet extends HttpServlet 
{
    ...
    public static HashMap<String, Responder> mResponderMap = new HashMap<String, Responder>();
 ...
 */
                        org.openlaszlo.i18n.LaszloMessages.getMessage(
                                LZServlet.class.getName(),"051018-363", new Object[] {requestID})
            );
            NDC.pop();
            NDC.remove();
        }
 ...
 */
    ...
    {
        Responder lzres = mResponderMap.get(lzt);
