...
public abstract class Responder 
{
     ...
     * exceptions. 
     * @return integer indicating mime-type. See {@link MIME_Type} enum in this
     * class.
     */
    public MIME_Type getMimeType() { return MIME_Type.HTML; }
     ...
     * @throws IOException 
     */
    protected InputStream compileXMLtoSWF(String xml, int flashversion)
            throws DataCompilerException, IOException {
        return DataCompiler.compile(xml, flashversion);
    }
 ...
 */
        ...
        try {
            ...
            in = compileXMLtoSWF(buf.toString(), mSWFVersionNum);
 ...
 */
                                        ...
                                        String mesg, String xmlBody, int serial)
    {
        ...
        try {
            ...
            InputStream swfbytes = compileXMLtoSWF(xml, mSWFVersionNum);
