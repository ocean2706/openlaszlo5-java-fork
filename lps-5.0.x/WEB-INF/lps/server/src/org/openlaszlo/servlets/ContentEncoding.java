...
public class ContentEncoding {
     ...
     */
    private static List<ContentEncoding> parseEncodings(HttpServletRequest req) {    
        ...
        ArrayList<ContentEncoding> encs = new ArrayList<ContentEncoding>(numEncodings);
    ...
    public static String chooseEncoding(HttpServletRequest req) {
        ...
        List<ContentEncoding> encs = parseEncodings(req);
        if (encs == null) {
            return null;
        }
