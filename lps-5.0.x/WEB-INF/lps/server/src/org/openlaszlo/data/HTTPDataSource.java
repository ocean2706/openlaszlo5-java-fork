 ...
 */
                        org.openlaszlo.i18n.LaszloMessages.getMessage(
                                HTTPDataSource.class.getName(),"051018-478", new Object[] {timeout})
);
 ...
 */
                        org.openlaszlo.i18n.LaszloMessages.getMessage(
                                HTTPDataSource.class.getName(),"051018-557", new Object[] {hcfg.getHost(), hcfg.getPort(), mConnectionTimeout})
            );
 ...
 */
                        org.openlaszlo.i18n.LaszloMessages.getMessage(
                                HTTPDataSource.class.getName(),"051018-592", new Object[] {code, HttpStatus.getStatusText(code)});
    }
