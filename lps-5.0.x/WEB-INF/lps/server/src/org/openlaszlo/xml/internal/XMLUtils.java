...
abstract public class XMLUtils {
     ...
     * U+09, U+0A, U+0D: these are the only C0 controls accepted in XML 1.0;
     * U+20–U+D7FF, U+E000–U+FFFD: this excludes some (not all) non-characters in the BMP (all surrogates, U+FFFE and U+FFFF are forbidden);
     * U+10000–U+10FFFF: this includes all code points in supplementary planes, including non-characters.
     *
     * All other code points should be escaped as &#xDDDD; where DDDD is hex representation
     ...
     */
    private static StringBuilder getXPathToInternal(Element elt) {
        ...
        StringBuilder sb = getXPathToInternal(parent);
        sb.append("/*[");
        // DOM is 1-based
        sb.append(i + 1);
        sb.append("]");
