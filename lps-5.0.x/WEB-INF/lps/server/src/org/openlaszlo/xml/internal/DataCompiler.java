...
public class DataCompiler extends DataCommon {
    ...
    */
    ...
    private static final DataContext writeXMLData(XmlPullParser xpp,
        ...
        Program bodyp = programs.lastElement();
    ...
    */
    public static Program makeProgram(Element data, DCOptions ioptions) throws CompilationError {
        ...
        try {
            ...
            Vector<Program> progs = makeProgram(xpp, null, x.length(), options);
    ...
    public static Vector<Program> makeProgram(XmlPullParser xpp, XmlPullParser xpheaders,
    ...
    private static FlashFile makeSWF(XmlPullParser xpp, XmlPullParser xpheaders, int xmlsize,
      ...
      throws IOException, XmlPullParserException {
        ...
        Vector<Program> progs = makeProgram(xpp, xpheaders, xmlsize, options);

        // iterate making a frame for each program
        while (progs.size() > 0) {
            Program prog = progs.firstElement();
